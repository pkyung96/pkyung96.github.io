$(function(){
    ...
    loading.fromTo("#header .container .title, .qick_menu_area, #header .container .menu_btn_area, .intro_cont .container .bg_img, .scroll_down",{
        y: "-100%",
        opacity:0
    },{
        y: "0%",
    ...
    loading.fromTo('.intro_cont .intro_dese', {
        opacity: 0,
        duration: 1,
    },{
        opacity: 1,
