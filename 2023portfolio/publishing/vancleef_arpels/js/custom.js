$(document).ready(function(){
	...
	$("section").on("mousemove",function(e){		
		...
		$(".p21").css({"right":-100+(posX/50) , "bottom":0+(posY/30) });
		$(".p22").css({"left":280+(posX/50) , "top":0+(posY/50) });

		// //세 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$(".p31").css({"right":0-(posX/30) , "top":0-(posY/30) });
		$(".p32").css({"right":20-(posX/50) , "top":10-(posY/50) });
		
		//네 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$(".p41").css({"left":300+(posX/30) , "top":0-(posY/30) });
		$(".p42").css({"right":-80+(posX/50) , "top":0-(posY/100) });	
	});
